...
function getKey(object: any, key): any {
    if (key == null)
        return key;
...
export function sortText(collection: any[], key: SortKeyCallableI | string | null = null): any[] {
    return collection.sort((a, b) => compareText(getKey(a, key), getKey(b, key)));
}

export function sortNumeric(collection: any[], key: SortKeyCallableI | string | null = null): any[] {
    return collection.sort((a, b) => compareNumeric(getKey(a, key), getKey(b, key)));
}

export function sortCurrency(collection: any[], key: SortKeyCallableI | string | null = null): any[] {
    return collection.sort((a, b) => compareCurrency(getKey(a, key), getKey(b, key)));
}

export function sortDate(collection: any[], key: SortKeyCallableI | string | null = null): any[] {
